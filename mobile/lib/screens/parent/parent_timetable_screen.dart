...
class ParentTimetableScreen extends StatelessWidget {
  const ParentTimetableScreen({super.key, required this.schoolId, required this.childId});
    ...
    return Scaffold(
      ...
      body: StreamBuilder<Student?>(
        ...
        builder: (context, studentSnap) {
          ...
          if (classId == null) return const Center(child: CircularProgressIndicator());
                  ...
                  return StreamBuilder<List<Teacher>>(
                    ...
                    builder: (context, teachersSnap) {
                      ...
                      return StreamBuilder<Timetable?>(
                        stream:
                            FirestoreService.docStream('schools/$schoolId/timetables/$classId', Timetable.fromMap),
