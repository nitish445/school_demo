...
/// Admin variant of the teacher's Mark Attendance screen -- lets the admin
/// pick any class school-wide (not just classes they're assigned to) to
/// view or correct attendance for.
class AdminAttendanceScreen extends StatefulWidget {
  const AdminAttendanceScreen({super.key, required this.schoolId});
        ...
        builder: (context, classSnap) {
          ...
          return Column(
            children: [
              ...
              if (_classId == null)
                const Expanded(
                    child: Center(child: Text('No classes set up yet.')))
              else
                Expanded(
                      ...
                      return StreamBuilder<List<AttendanceRecord>>(
                        ...
                        builder: (context, recordSnap) {
                          ...
                          if (students.isEmpty) {
                            return const Center(
                                child:
                                    Text('No active students in this class.'));
                          }
